...
class Session:
    ...
    def set_partitions(self, partition_map, align_map):
        self._sess.set_partitions(partition_map)
        self._sess_options.enable_partitioning = True
        self._reset_session(['CPUExecutionProvider', 'PIMExecutionProvider'], None, partition_map, align_map)
...
class InferenceSession(Session):
    ...
    This is the main class used to run a model.
    """
    def __init__(self, path_or_bytes, sess_options=None, providers=None, provider_options=None, partition_map=None, align_map=None):
        """
        ...
        try:
            self._create_inference_session(providers, provider_options, partition_map, align_map)
        except RuntimeError:
            if self._enable_fallback:
    ...
    def _create_inference_session(self, providers, provider_options, partition_map=None, align_map=None):
        ...
        sess.initialize_session(providers or [], provider_options or [], partition_map or {}, align_map or {})
    ...
    def _reset_session(self, providers, provider_options, partition_map=None, align_map=None):
