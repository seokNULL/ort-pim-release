...
PIMExecutionProviderInfo PIMExecutionProviderInfo::FromProviderOptions(const ProviderOptions& options) {
...
ProviderOptions PIMExecutionProviderInfo::ToProviderOptions(const PIMExecutionProviderInfo& info) {
