// #include "pim_register_customops.h"
...
// static const char *c_OpDomain = "kOnnxDomain";
...
// struct FusedMatMulAddOp : Ort::CustomOpBase<FusedMatMulAddOp, FusedMatMulAdd> {
//     void *CreateKernel(OrtApi api, const OrtKernelInfo * /* info */) const {
//         return new FusedMatMulAdd(api);
//     };

//     const char *GetName() const { return "FusedMatMulAdd"; };
...
//     if (auto status = ortApi->CustomOpDomain_Add(domain, &c_FusedMatMulAdd)) {
//         return status;
//     }
