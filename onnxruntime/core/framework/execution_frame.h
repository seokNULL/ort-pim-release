...
class IExecutionFrame {
 ...
 public:
  ...
  Status GetOrCreateNodeOutputMLValue(int index, const TensorShape* shape, OrtValue*& p_ort_value, size_t nnz = 0, bool pim_output = false);
 ...
 private:
  ...
  //                                            size_t nnz) = 0;
  virtual Status CreateNodeOutputMLValueImpl(OrtValue& ort_value, int ort_value_idx, const TensorShape* shape,
                                             size_t nnz, bool pim_output = false) = 0;
...
class ExecutionFrame final : public IExecutionFrame {
 ...
 private:
  ...
  Status CreateNodeOutputMLValueImpl(OrtValue& ort_value, int ort_value_idx, const TensorShape* shape, size_t nnz, bool pim_output = false) override;
  ...
  //                                            size_t nnz);
  common::Status AllocateAsPerAllocationPlan(OrtValue& ort_value, int ort_value_index, const TensorShape* shape,
                                             size_t nnz, bool pim_output = false);
